...
var savecode="/pages/office/save.ashx";//保存文档程序程序
...
//保存office文档
function saveFileToUrl(wordUrl) {
	...
	if(IsFileOpened)
	{
		...
		"savetype=1&fileType=" + fileType + "&word=" + wordUrl,          //与控件一起提交的参数,savetype参数为要保存的文件格式office,html,pdf。filetype参数保存文件类型
