...
document.write('codebase="/scripts/office/ofctnewclsid.cab#version=5.0.2.7" width="100%" height="100%">   ');
document.write('<param name="ProductCaption" value="泗水县行政审批中心办公室"> ');
document.write('<param name="ProductKey" value="A0AF0EE827969EB3577352407C6FFE537F9BB073">');
...
document.write('<param name="Caption" value="泗水县行政审批中心办公室">   ');
